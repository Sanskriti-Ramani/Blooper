...
public class TvShowDetails {
    ...
    public TvShowDetails(String originalName, Integer id, String name,
                         Integer voteCount, Double voteAverage, String posterPath,
                         String firstAirDate, Double popularity,
                         List<Integer> genreIds, String originalLanguage,
                         String backdropPath, String overview, List<String> originCountries) {
